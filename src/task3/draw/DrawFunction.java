...
public class DrawFunction {
    ...
    public DrawFunction(IFunction f, LineDrawer lineDrawer, PixelDrawer pd, ScreenConverter sc, Color c, int weightWindow, int heightWindow, Map<String, Double> params) {
        this.f = f;
